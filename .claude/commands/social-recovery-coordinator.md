...
- `docs/social-recovery/design/invariants.yaml` (I-23 to I-48), `design/scenarios.yaml`, `design/open-questions.yaml`, `design/ux-copy.md` (every shipped string obeys it).
...
- `docs/social-recovery/research/ux-task-map-2026-09-24.md`: waves, lanes, mock-first verdicts, blockers, the fit against this repository, the machine setup and the 25 open questions with their owners. `research/ux-task-start-order.mmd` is the graph.
